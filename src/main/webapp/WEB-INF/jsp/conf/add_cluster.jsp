            ...
            <div class="col-md-12">
               ...
               <div class="portlet box blue">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-reorder"></i>新增集群信息</div>
                  </div>
                  <div class="portlet-body form">
                     <!-- BEGIN FORM-->
                     <form action="add_cluster.do" method="post" class="form-horizontal form-bordered form-row-stripped form-control-static">
                        <div class="form-body">
