            ...
            <div class="col-md-12">
               ...
               <div class="portlet box blue">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-reorder"></i>修改数据中心信息</div>
                  </div>
                  <div class="portlet-body form">
                     <!-- BEGIN FORM-->
                     <form action="mod_dataCenter.do" method="post" class="form-horizontal form-bordered form-row-stripped form-control-static">
                        <div class="form-body">
