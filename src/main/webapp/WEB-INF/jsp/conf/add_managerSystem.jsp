            ...
            <div class="col-md-12">
               ...
               <div class="portlet box blue">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-reorder"></i>新增管理系统信息</div>
                  </div>
                  <div class="portlet-body form">
                     <!-- BEGIN FORM-->
                     <form action="add_managerSystem.do" method="post" class="form-horizontal form-bordered form-row-stripped form-control-static">
                        <div class="form-body">
                           <div class="form-group">
                              <label class="control-label col-md-3">管理系统名称<span class="required">*</span></label>
                              <div class="col-md-4">
                                 <input type="text" class="form-control" maxlength="200" name="name" id="name">
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="control-label col-md-3">管理系统描述<span class="required">*</span></label>
                              <div class="col-md-4">
