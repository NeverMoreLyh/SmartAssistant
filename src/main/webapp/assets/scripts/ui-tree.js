    ...
    return {
        ...
        init: function () {
            ...
            var treeDataSource6 = new DataSourceTree({
                data: [
                    { name: '<i class="icon-shopping-cart"></i>联机<div class="tree-actions"><i class="icon-plus"></i><i class="icon-edit"></i><i class="icon-remove"></i></div>', type: 'item', additionalParameters: { id: 'F11' } },
                    { name: '<i class="icon-shopping-cart"></i>批量<div class="tree-actions"><i class="icon-plus"></i><i class="icon-edit"></i><i class="icon-remove"></i></div>', type: 'item', additionalParameters: { id: 'F12' } },
                    { name: '<i class="icon-shopping-cart"></i>dmb<div class="tree-actions"><i class="icon-plus"></i><i class="icon-edit"></i><i class="icon-remove"></i></div>', type: 'item', additionalParameters: { id: 'I11' } },
                    { name: '<i class="icon-shopping-cart"></i>apm-web<div class="tree-actions"><i class="icon-plus"></i><i class="icon-edit"></i><i class="icon-remove"></i></div>', type: 'item', additionalParameters: { id: 'I12' } },
                    { name: '<i class="icon-shopping-cart"></i>批处理平台<div class="tree-actions"><i class="icon-plus"></i><i class="icon-edit"></i><i class="icon-remove"></i></div>', type: 'floder', additionalParameters: { id: 'F11' } }
                ],
                delay: 400
            });    
